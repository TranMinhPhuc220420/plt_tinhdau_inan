...
(function () {
    ...
    var SearchPane = /** @class */ (function () {
         ...
         * @param idx the index.js of the column for this pane
         * @returns {object} the pane that has been created, including the table and the index.js of the pane
         */
        function SearchPane(paneSettings, opts, idx, layout, panesContainer, panes) {
            ...
            //  reassign all of the panes indexes to the new index.js of the column.
            ...
            if (this.colExists) {
                ...
                if (!this.s.dt.page.info().serverSide && dataIn === null) {
                    ...
                    if (rowData.arrayFilter.length === 0) {
                        ...
                        this._detailsPane();
                        if (loadedFilter && loadedFilter.searchPanes && loadedFilter.searchPanes.panes) {
                            // If the index.js is not found then no data has been added to the state for this pane,
         ...
         * @param rowIdx The current row index.js to be compared
         ...
         * @param dataIndex the row index.js
         */
        ...
        SearchPane.prototype._searchExtras = function () {
            ...
            // If null index.js is found then search for empty cells as a filter.
            if (nullIndex > -1) {
                filters[nullIndex] = '';
            }
    ...
    var SearchPanes = /** @class */ (function () {
                ...
                //  more selections may be made in that pane.
                    ...
                    for (var _i = 0, _a = this.s.panes; _i < _a.length; _i++) {
                        ...
                        if (pane.s.dtPane !== undefined) {
                            ...
                            // If filterPane === -1 then a pane with a selection has not been found yet, so set filterPane to that panes index.js
        ...
        SearchPanes.prototype._cascadeRegen = function (newSelectionList) {
            ...
            // If only one pane has been selected then take note of its index.js
            var solePane = -1;
            if (newSelectionList.length === 1) {
                solePane = newSelectionList[0].index;
            }
        ...
        SearchPanes.prototype._makeCascadeSelections = function (newSelectionList) {
            ...
            for (var i = 0; i < newSelectionList.length; i++) {
                ...
                var this_1 = this;
                // As the selections may have been made across the panes in a different order to the pane index.js we must identify
                //  which pane has the index.js of the selection. This is also important for colreorder etc
                for (var _i = 0, _a = this.s.panes; _i < _a.length; _i++) {
                    var pane = _a[_i];
                    _loop_1(pane);
                }
