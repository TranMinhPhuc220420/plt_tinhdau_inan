...
$.extend( KeyTable.prototype, {
	...
	/**
	 * Focus on a cell
	 * @param  {integer} row    Row index.js
	 * @param  {integer} column Column index.js
	 */
	...
	/**
	 * Is the cell focused
	 * @param  {object} cell Cell index.js to check
	 ...
	 *   visible row index.js (from the whole data set) - NOT the data index.js
	 * @param  {integer} [column] Not required if a cell is given as the first
	 *   parameter. Otherwise this is the column data index.js for the cell to
	 *   focus on
	...
	_shift: function ( e, direction, keyBlurable )
	{
		...
		var
			row = currRow,
			column = columns[ currCol ]; // row is the display, column is an index.js
...
KeyTable.defaults = {
	...
	/**
	 * Tab index.js for where the table should sit in the document's tab flow
	 * @type {integer|null}
	 */
	tabIndex: null
};
