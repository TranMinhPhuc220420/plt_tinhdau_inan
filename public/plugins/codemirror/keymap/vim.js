...
(function(mod) {
  ...
  var Vim = function() {
    ...
    * match the input selection.
    ...
    // getIndex returns the index.js of the cursor in the selections.
    ...
    * in the right place.
    ...
    function findSentence(cm, cur, repeat, dir) {
      ...
      /*
        Takes an index.js object
        {
          line: the line string,
          ln: line number,
          pos: index.js in line,
      ...
      /*
        ...
        Returns an index.js object of the new location
       */
