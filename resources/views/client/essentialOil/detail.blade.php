                            ...
                            <ol class="carousel-indicators">
                                @foreach($listImage as $item)
                                    <li data-target="#carouselId"
                                        ...
                                        <img src="/image/essential-oil/product/{{ $idProduct. '/' . $item->idImage }}"
                                             alt="First slide">
                                    </li>
                                @endforeach
                            </ol>
                            ...
                            <div class="col-md-4 my-2">
                                <div class="card text-left">
                                    <img class="card-img-top"
                                         src="/image/essential-oil/product/{{ $idProduct. '/' . json_decode($item->EssentialOilProduct_ListImage)[0]->idImage }}"
                                         alt="">
                                    <div class="card-body">
